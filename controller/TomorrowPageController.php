<?php 
class TomorrowPageController extends ControladorBase{
    ...
    public function LoadToday()
    {
        ...
        $tablas = "citas INNER JOIN estados 
                    ON citas.id_estados= estados.id_estados";
        $where ="citas.fecha_citas='".$tomorrow."' AND estados.nombre_estados='ACTIVO'";
        ...
        else
        {
            ...
            $html.='<h4>Внимание!</h4> <b>Нет больше записей на завтра</b>';
            $html.='</div>';
            $html.='</div>';
